...
const KB = [
  ...
  },
  {
    ...
    soft: ['介绍', '背景', '谁', '了解', '认识'],
    answer:
      `嗨～志智姐姐是一位常驻${CITY}的 AI 产品经理哦！她有 6 年多的 B 端 UI / 交互设计积淀，最近 2.5 年又一头扎进了 AI 应用落地。她自己一个人就把「AI 合同审核」「智能客服」「AI 标书撰写」「AI 发票审核」这 4 款产品从 0 到 1 跑通上线，超靠谱的～`,
  },
  {
    id: 'ability',
...
三是设计思维，6 年多的 B 端设计沉淀让她特别在意产品体验细节。
简单说，她能把「AI 能做什么」翻译成「用户真的用得顺」。`,
  },
  {
    id: 'skills',
    kws: ['技能', '工具', '技术栈', '用什么', '栈', 'coze', 'dify', 'cursor', 'claude', 'codex', 'figma', 'sketch', 'prompt', 'rag', 'agent', 'workflow', 'vibe', 'photoshop', 'illustrator'],
    soft: ['技能', '工具'],
    answer:
      `她的工具箱可热闹啦～
AI 协作上常用 Claude、Codex 做需求分析和文档原型；智能体搭建用 Coze、Dify 编排 Workflow，反复打磨 Prompt；原型设计离不开 Figma、Sketch；也会用 Vibe Coding 快速跑通 MVP 并部署上线。
...
· AI 合同审核：把单份合同审核从 45 分钟压到 8 分钟，风险条款识别准确率约 92%，已服务 3 家种子客户；
· 智能客服：7×24 在线，日均处理约 60% 会话，支持 2 家种子客户；
· AI 标书撰写：撰写时间缩短约 75%，已服务 2 家种子客户试用；
· AI 发票审核：准确率约 90%，单张处理从 15 分钟降到 2 分钟，已支持 2 家客户。
想了解哪一款，我展开给你讲呀～`,
  },
  {
    id: 'contract',
...
效果上，单份合同审核从 45 分钟降到 8 分钟，风险条款识别准确率提升到 92%，已经有 3 家种子客户在试运行啦～`,
  },
  {
    id: 'service',
...
背景是企业月底报销、对账压力大，人工逐张核对又慢又容易出错。志智姐姐设计了「上传 → OCR → 信息抽取 → 规则校验 → 异常标记 → 人工兜底」的完整链路，准确率约 90%，单张处理从约 15 分钟降到 2 分钟，已经支持 2 家客户试用～`,
  },
  {
    id: 'career',
...
早期她在中国移动、创业团队做 B 端 UI / 交互设计，累计 6 年以上，主导过 AIGC 数字藏品、区块链存证等模块的体验设计；2024 年起正式转向 AI 产品经理，把设计思维带进 AI 产品落地，独立完成 4 款 AI 应用从需求、PRD 到上线的全过程。
...
她的差异化在于：既有 6 年多的 B 端设计经验，懂得业务流程和体验细节，又能自己用 Coze / Dify / Vibe Coding 把想法快速做成可验证的 MVP。
...
相比学历，她 6 年多的 B 端设计和 AI 产品实战经验更能说明问题哦～`,
  },
  {
    id: 'clients',
